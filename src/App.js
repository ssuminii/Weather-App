...
const API_key = `e9bb250df4812c325925ea44d394e8c4`;

// 1. 앱이 실행되자마자 현재위치기반의 날씨가 보인다.
// 2. 날씨 정보에는 도시, 섭씨, 화씨, 날씨 상태
// 3. 5개의 버튼이 있다. (1개 -> 현재위치, 4개 -> 다른도시)
...
function App() {
  ...
  const cities = ['New York', 'Los Angeles', 'Paris', 'Singapore'];

  const getCurrentLoacation = () => {
  ...
  const getWeatherByCity = async () => {
    // city -> const [city, setCity] = useState('');
